...
export type SearchUsersQuery = z.infer<
  typeof UserSchema.searchUsersQuerySchema.shape.query
>

export type UserIdParams = z.infer<typeof UserSchema.userIdParams.shape.params>
